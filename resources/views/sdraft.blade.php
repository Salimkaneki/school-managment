                        ...
                        <div class="card-body px-0 py-0">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0 table-bordered text-center">
                                    ...
                                    <tbody>
                                        <!-- Boucle sur les élèves ici -->
                                        <tr>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold">John Doe</h6>
                                                    <p class="text-sm text-secondary mb-0">Nationalité</p>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">123456789</p>
                                                <p class="text-sm text-secondary mb-0">Téléphone</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-secondary text-sm font-weight-normal">johndoe@example.com</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-sm font-weight-normal">Classe A</span>
                                            </td>
                                            <td class="align-middle text-center">
