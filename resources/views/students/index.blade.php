                                ...
                                <div class="ms-auto d-flex">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actionMenu">
                                        ...
                                        {{-- <a href="{{ route('students-by-class') }}" class="dropdown-item">Élèves par Classe</a> --}}
                                                                                ...
                                                                                <div class="row g-4">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        ...
                                                                                        <div class="row g-3">
                                                                                            @php
                                                                                            $mainInfo = [
                                                                                                ['icon' => 'calendar', 'label' => 'Date de naissance', 'value' => $student->date_of_birth ? \Carbon\Carbon::parse($student->date_of_birth)->format('d/m/Y') : 'Non renseigné'],                                                                                                ['icon' => 'venus-mars', 'label' => 'Genre', 'value' => $student->gender == 'male' ? 'Masculin' : ($student->gender == 'female' ? 'Féminin' : 'Autre')],
